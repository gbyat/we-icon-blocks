...
if (
    ...
    const { PanelBody, SelectControl, RangeControl, ToggleControl, TextControl, Button, Modal, TextareaControl } = wp.components;
    const { __ } = wp.i18n;
    ...
    registerBlockType('webentwicklerin/icon', {
        edit: ({ attributes, setAttributes }) => {
            ...
            const effectiveFrameSvg = frameSvgAdvanced && frameSvgManual
                ? frameSvgManual
                : frameSvgRaw;
                        ...
                        <PanelBody title={__('Background Frame', 'we-icon-blocks')} initialOpen={false}>
                            <SelectControl
                                ...
                                options={[
                                    ...
                                    { label: __('Icon library SVG', 'we-icon-blocks'), value: 'library' },
                                ]}
                                onChange={(value) => {
                                    const update = { frameMode: value };
                                    if (value === 'none') {
                                                    ...
                                                    window.fetch(url, { credentials: 'same-origin' })
                                                        ...
                                                        .then((svgText) => {
                                                            if (typeof svgText === 'string') {
                                                                ...
                                                                setAttributes({ frameSvgRaw: safe });
                                                            }
                                                        })
                                                        // eslint-disable-next-line no-console
                            ...
                            {frameMode === 'library' && (
                                <SelectControl
                                    ...
                                    value={frameIconName || ''}
                                    options={[
                                        { label: __('Select frame icon…', 'we-icon-blocks'), value: '' },
                                        ...iconOptions,
                                    ]}
                                    onChange={(value) => {
                                        if (!value) {
                            ...
                            {frameMode && frameMode !== 'none' && (
                                <>
                                    <RangeControl
                                        ...
                                        onChange={(value) => setAttributes({ framePadding: value === 0 ? '0' : value + 'em' })}
                                        min={0}
                                        max={10}
                                        step={0.1}
                                    ...
                                    {typeof window !== 'undefined' && window.weIconBlocksCanEditSvg && (
                                        <>
                                            <ToggleControl
                                                label={__('Enable advanced SVG code (experts only)', 'we-icon-blocks')}
                                                checked={frameSvgAdvanced}
                                                onChange={(value) => setAttributes({ frameSvgAdvanced: value })}
                                            ...
                                            {frameSvgAdvanced && (
                                                <TextareaControl
                                                    ...
                                                    onChange={(value) => setAttributes({ frameSvgManual: sanitizeFrameSvg(value) })}
                            ...
                            {animation && animation !== 'none' && (
                                <>
                                    <SelectControl
                                        ...
                                        options={[
                                            { label: __('Fast', 'we-icon-blocks'), value: 'strong' },
                                            { label: __('Medium', 'we-icon-blocks'), value: 'normal' },
                                            { label: __('Slow', 'we-icon-blocks'), value: 'soft' },
                                        ]}
                    ...
                    <div {...blockProps}>
                        {linkUrl ? (
                            ...
                            >
                                {iconPosition === 'top' && (
                                    <>
                                        {frameMode && frameMode !== 'none' && (effectiveFrameSvg || frameImageUrl) ? (
                                            <div className="wp-block-webentwicklerin-icon__frame">
                                                {effectiveFrameSvg ? (
                                                    <span dangerouslySetInnerHTML={{ __html: effectiveFrameSvg }} />
                                                ) : frameImageUrl ? (
                                ...
                                {iconPosition !== 'top' && (
                                    <>
                                        {iconPosition === 'bottom' && hasText && text && (
                                            <span className={screenReaderOnly ? 'screen-reader-text' : 'icon-text'}>{text}</span>
                                        )}
                                        {frameMode && frameMode !== 'none' && (effectiveFrameSvg || frameImageUrl) ? (
                                            <div className="wp-block-webentwicklerin-icon__frame">
            ...
            return (
                <div {...blockProps}>
                        ...
                        >
                            {iconPosition === 'top' && (
                                <>
                                    {frameMode && frameMode !== 'none' && (frameSvgRaw || frameImageUrl) ? (
                                        <div className="wp-block-webentwicklerin-icon__frame">
                                            {frameSvgRaw ? (
                                                <span dangerouslySetInnerHTML={{ __html: frameSvgRaw }} />
                                            ) : frameImageUrl ? (
                                                <img src={frameImageUrl} alt="" />
                                            ) : null}
                                            <div
