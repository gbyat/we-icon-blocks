...
/**
 * Create initial release without version bumping.
 *
...
console.log('🚀 Creating initial release for WE Icon Blocks...\n');
...
try {
    ...
    console.log('   2. Create we-icon-blocks.zip');
    ...
    console.log('   https://github.com/gbyat/we-icon-blocks/actions');
    console.log('');
    console.log('📝 For future releases, use:');
    console.log('   npm run release:patch   (x.y.z → x.y.(z+1))');
    console.log('   npm run release:minor   (x.y.z → x.(y+1).0)');
    console.log('   npm run release:major   (x.y.z → (x+1).0.0)');
    console.log('');
} catch (error) {
